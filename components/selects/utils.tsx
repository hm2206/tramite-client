...
const uid = (length: number = 10) => Math.random().toString(36).substring(2, 2 + length);
...
const SelectBase = ({
    ...
    useEffect(() => {
        if (nextPage > 1) getDatos(nextPage);
    }, [nextPage]);
