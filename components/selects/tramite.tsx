...
const SelectTramiteType = ({ id = "id", name, value, onChange, refresh, error = false, disabled = false }: any) => {
    return <SelectBase
        execute={true}
        api={tramite}
        url={`tramite_type`}
...
const SelectConfigDependenciaDestino = ({ id = "id", name, dependencia_id, value, onChange, error = false, onReady = null }: any) => {
    return <SelectBase 
        execute={false}
        api={tramite}
...
const SelectDependenciaExterna = ({ id = "id", name, entity_id, value, onChange, error = false, onReady = null, disabled = false, code = null }: any) => {
    return <SelectBase 
        execute={false}
        api={tramite}
